...
## Related ADRs
- [ADR-002: Adopt a watchdog (timeout) for microphone-disconnect detection](../ADRs/documents/ADRs/ADR002-Adopt a watchdog (timeout) for microphone-disconnect detection.md)
