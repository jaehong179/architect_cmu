# EXP-14 / Experiment for [[RISK-19](../06-risk-management.md#risk-19)][[QAS-11](../04-quality-attribute-requirements.md#qas-11-microphone-disconnect-user-notification)]: Characterize current behavior on microphone (USB) disconnect
...
- A documented current-state behavior for each disconnect case: (a) how the GUI reacts (freezes, keeps last value, shows nothing, or errors), (b) measured time until any visible change, and (d) whether capture/measurement auto-recovers on reconnect. This becomes the baseline and the detection-signal basis for [QAS-11](../04-quality-attribute-requirements.md#qas-11-microphone-disconnect-user-notification) / EXP-06.
...
[QAS-01](../04-quality-attribute-requirements.md#qas-01-real-time-streaming-throughput) · [RISK-19](../06-risk-management.md#risk-19) · EXP-06
